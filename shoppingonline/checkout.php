...
<html lang="en">
  <head>
    ...
    <title>Queen Shop | หน้าจ่ายเงิน</title>
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>0639541996</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="index.php">
                  ...
                  <p>Quees<strong>Shop</strong> <span>ร้านอุปกรณ์เสริมสวย</span></p>
                </a>
                <!-- img based logo -->
...
<div class="panel-heading">
   ...
   <div class="col-md-12">
   <div class="aa-checkout-single-bill">
   <textarea cols="8" name="address" value= "ที่อยู่ *" rows="3"></textarea>
</div>
</div>
</div>                         
</div>
                ...
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    ...
                    <address>
                      ...
                      <p><span class="fa fa-envelope"></span>Kittipol.w@acc.msu.ac.th</p>
                    </address>
