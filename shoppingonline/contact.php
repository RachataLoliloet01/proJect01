...
$select_mixed = "SELECT max(oid) from orders";
...
if(!empty($_GET["action"])){
	...
	if($productByCode[0]["unit"]< $_POST["quantity"]){
		$message = "สินค้าเกินใจนวนคงเหลือ";
               ...
               <div class="col-md-4">
                 <div class="aa-contact-address-right">
                   <address>
                     ...
                     <p><span class="fa fa-phone"></span>+66 935488711</p>
                     <p><span class="fa fa-envelope"></span>Email:63010974014@msu.ac.th</p>
                   </address>
                 </div>
               </div>
             </div>
