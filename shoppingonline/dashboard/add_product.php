<?php
  ...
  //     $str = "INSERT INTO tbproduct (id,name,code,image,price,tproid,unit,sale)
  //     VALUE('','$name','$code','$image','$price','$type','$unit','')";
  ...
  if(move_uploaded_file($_FILES["image"]["tmp_name"],"../product-images/".$_FILES["image"]["name"])){
    ...
    $str = "INSERT INTO tblproduct (id, name, code, image, price, tproid, unit, sale) VALUES ('', '$name', '$code', '$image', '$price', '$type', '$unit', '')";
      mysqli_query($link, $str);
        ...
        echo "<script>";
        echo "alert('Failed to add information');";
        echo "</script>";
        echo "Copy/Upload Complete<br>";
    }
...
<head>
  ...
  <title>Queen SHOP DASHBOARD</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="#">Queen SHOP DASHBOARD</a>
...
echo $data['tproname'];?></option>
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <input id="name" name="code" type="text" class="form-control input-md" required="">
                <span class="help-block">กรอกรหัสสินค้า</span>
              </div>
            </div>
            <!-- Text input-->
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <input id="name" name="price" type="text" class="form-control input-md" required="">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <input id="name" name="unit" type="text" class="form-control input-md" required="">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <input id="name" name="image" type="file" class="form-control input-md" required="">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <button id="submit" name="add_product" class="btn btn-success">บันทึกสินค้า</button>
              </div>
            </div>
          </fieldset>
        </form>
