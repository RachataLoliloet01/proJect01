...
?>
      <tr>
        ...
        <td><?php echo $data['name']." ".$data['name2'];?></td>
		<td><a  href="JavaScript:window.location='orders_detail.php?oid=<?=$data['oid'];?>',
		...
		<td><?php echo $data['tel'];?></td>
		  ...
		  <td>
			...
			<center><a class="btn btn-danger" href="JavaScript:if(confirm('ลบออเดอร๋นี้ ?')==true)
                   JavaScript:window.location='orders_delete.php?oid=<?=$data['oid'];?>',
